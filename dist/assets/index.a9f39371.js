...
const SplashScreen = registerPlugin("SplashScreen", {
  web: () => __vitePreload(() => import("./web.c496d5fd.js"), true ? [] : void 0).then((m) => new m.SplashScreenWeb())
});
var CameraSource;
...
registerPlugin("Camera", {
  web: () => __vitePreload(() => import("./web.2fe4dd88.js"), true ? [] : void 0).then((m) => new m.CameraWeb())
});
...
window.customElements.define(
  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      const self2 = this;
      self2.shadowRoot.querySelector("#requestCovers").addEventListener("click", async function(e) {
        try {
